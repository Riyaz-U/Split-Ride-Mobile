...
class StateUpdater(
    ...
    fun processIntent(intent: Intent) {
        ...
        if (reducerHolder != null) {
            reducerHolder.reducer.invoke(intent)
        } else {
...
class ReducerBuilder{
    ...
    inline fun <reified I: Intent> on(noinline reducer: I.() -> Unit){
        reducers.put(I::class.qualifiedName!!, ReducerHolder(reducer as Intent.() -> Unit))
    }
